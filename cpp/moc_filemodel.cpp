...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_FileModel_t, stringdata) + ofs \
...
static const uint qt_meta_data_FileModel[] = {
 ...
 // properties: name, type, flags
       1, QMetaType::QString, 0x00095903,
...
const QMetaObject FileModel::staticMetaObject = {
    { &QAbstractListModel::staticMetaObject, qt_meta_stringdata_FileModel.data,
      qt_meta_data_FileModel,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_FileModel.stringdata))
...
int FileModel::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_id < 0)
     ...
     if (_c == QMetaObject::ReadProperty) {
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QString*>(_v) = getSearchPath(); break;
        }
        _id -= 1;
    } else if (_c == QMetaObject::WriteProperty) {
        void *_v = _a[0];
        switch (_id) {
        case 0: setSearchPath(*reinterpret_cast< QString*>(_v)); break;
        }
        _id -= 1;
